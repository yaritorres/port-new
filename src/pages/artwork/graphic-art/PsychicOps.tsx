    ...
    <>
      <div className={mainSectionStyle}>
        <div className='col-span-3 flex flex-row gap-x-6 md:gap-x-10 items-center'>
          ...
          <h2 className='text-4xl md:text-5xl'> PSYCHIC_OPS </h2>
        </div>
        <img
          src="public/psychic_ops.jpeg"
        ...
        <div className={`flex flex-col gap-y-3 col-span-4 col-start-5 row-start-3 text-xs`}>
          ...
          <div className='flex flex-col md:flex-row'>
            <p className='flex flex-row'> details the&nbsp; </p>
            <s> psionic manipulation </s>
            <p className='hidden md:inline'> &nbsp;customer support division of the&nbsp; </p>
            <p className='md:hidden'> customer support division of the&nbsp; </p>
